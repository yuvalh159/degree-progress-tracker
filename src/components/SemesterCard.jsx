        ...
        <div className="google-card">
            ...
            >
                <div className="flex justify-between items-center p-3 border-b border-gray-200 bg-gray-50">
                    <h2 className="text-md font-semibold text-gray-700">{semesterName}</h2>
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            className="text-gray-500 hover:text-red-500 transition-colors p-1.5 rounded-md hover:bg-red-50"
                        >
